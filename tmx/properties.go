...
type Properties struct {
	...
	// Wraps any number of custom properties. Can be used as a child of the map, tileset, tile (when part of a tileset),
	// terrain, layer, objectgroup, object, imagelayer and group elements.
}
